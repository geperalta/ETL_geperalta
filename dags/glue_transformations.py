...
glue_iam_role = "glue_admin_gera" #Edited/created from iAM from AWS
...
with DAG(dag_id = DAG_ID, schedule_interval = "@once",
    ...
    glue_job_step_logs = AwsGlueJobOperator(
        ...
        script_location = "s3://s3-data-bootcamp-gera1508/scripts/logs_transform.py",
    ...
    glue_job_step_revs = AwsGlueJobOperator(
        ...
        script_location = "s3://s3-data-bootcamp-gera1508/scripts/revs_transform.py",
